...
@Entity
@Table(name = "materia_prima", schema = "pinguim")
class MateriaPrima(
    @Id
    ...
    var tipoEntrada: String,  // CAIXA, PACOTE, KG

    @Column(name = "quantidade_entrada", nullable = false, precision = 10, scale = 4)
    var quantidadeEntrada: BigDecimal,
