Feature: Vendas Pinguim Ice Admin
  ...
  Scenario: Registrar uma venda com sucesso
    ...
    When eu registro uma venda para a região "Centro" com os seguintes itens:
      | Sabor   | Quantidade |
      | Morango | 10         |
  ...
  Scenario: Tentar registrar venda sem estoque suficiente
    Given que eu estou autenticado como "admin@pinguimice.com.br"
    When eu tento registrar uma venda para a região "Centro" com os seguintes itens:
      | Sabor   | Quantidade |
      | Morango | 101        |
  ...
  Scenario: Cancelar uma venda e restaurar estoque
    Given que eu estou autenticado como "admin@pinguimice.com.br"
    And que foi registrada uma venda para a região "Centro" com 10 gelinhos de "Morango"
